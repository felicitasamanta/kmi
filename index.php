...
<div class="container justify-content-between align-items-center flex-wrap d-flex " style="min-height: 100vh">
    ...
    <form class="bg-light p-5 rounded shadow1 d-flex-column" action="result.php" method="get">
        <p class="name">KMI skaičiuoklė</p>
        <hr>
        <div class="d-flex row mb-3">
            <label for="height" class="col-2 col-lg-4 col-form-label">Ūgis: </label>
            <div class="col-10 col-lg-8 d-flex flex-row">
                <input type="number" name="height" class="form-control rounded-pill text-end"  placeholder="175cm" min="0" id="ugis">
            </div>
        </div>
        <div class="row mb-3">
            <label for="weight" class="col-2 col-lg-4 col-form-label">Svoris: </label>
            <div class="col-10 col-lg-8">
                <input type="number" name="weight" class="form-control rounded-pill" placeholder="70kg" id="svoris">
            </div>
        </div>
        <div class="d-flex justify-content-center"><button type="submit" class="btn btn-danger">Skaičiuoti KMI</button></div>
